...
Route::middleware(['authentication'])->group(function () {
    ...
    Route::get('/archived-file/{archivedType}/file-manager/{type}/municipality', [AdminController::class, 'ShowArchivedMunicipality'])->name('archived.file-manager.municipality.show');
    Route::get('/archived-file/{archivedType}/file-manager/{type}/categories', [AdminController::class, 'ShowArchivedandTitlesOrPatentedLots'])->name('archived.file-manager.land-title.show');
    Route::get('/archived-file/{archivedType}/file-manager/{type}/{category}/municipality', [AdminController::class, 'ShowArchivedMunicipalityWithCategory'])->name('archived.file-manager.municipality.with-category.show');
    Route::get('/archived-file/{archivedType}/file-manager/{type}/{category}/{municipality}', [AdminController::class, 'ShowArchivedFileManagerTableWithCategory'])->name('archived.file-manager.table.with-category.show');
    Route::get('/archived-file/{archivedType}/file-manager/{type}/{municipality}', [AdminController::class, 'ShowArchivedFileManagerTable'])->name('archived.file-manager');
    ...
    Route::get("/archived-file/{archivedType}/administrative-document/{record}", [AdminController::class, 'ShowArchivedAdministrativeDocumentRecord'])->name('archived.administrative.record.show');
