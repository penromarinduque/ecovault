...
@section('content')
    ...
    <div class="h-[calc(90vh-100px)] rounded-md text-black p-4 bg-white shadow-md border border-300 mt-2">
        ...
        <h1 class="font-medium  text-2xl text-gray-500">Chainsaw Registration</h1>
        ...
        <div class="grid grid-cols-4 gap-8 m-16 text-gray-700 font-semibold">
            ...
            <div class="flex flex-col items-center">
                <a href="{{ route('archived-file.file-manager.municipality.show', ['type' => 'chainsaw-registration', 'category' => 'new']) }}">
            ...
            <!-- Category 2 -->
            <div class="flex flex-col items-center">
                <a href="{{ route('archived-file.file-manager.municipality.show', ['type' => 'chainsaw-registration', 'category' => 'renewal']) }}">
