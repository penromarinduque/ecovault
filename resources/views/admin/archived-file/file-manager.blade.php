...
@section('title', 'PENRO Archiving System')
    ...
    @section('content')
            ...
            'type' => 'tree-plantation-registration',
                                ...
                                <div class="flex flex-col items-center">
                                    <a href="{{ route('archived-file.file-manager.municipality.show', ['type' => 'transport-permit']) }}" class="text-center">
                            ...
                            <div class="grid grid-cols-4 gap-8 mx-16 text-gray-700 font-semibold">
                                                    <div class="flex flex-col items-center">
                                                        <a href="{{ route('archived-file.file-manager.land-title.show', ['type' => 'land-title']) }}" class="text-center">
