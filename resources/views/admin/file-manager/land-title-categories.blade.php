...
@section('content')
    <div class="bg-slate-200 h-[600px] rounded-md text-black p-4 ">
        ...
        <div class="grid grid-cols-3 m-16 ">
            ...
            <div class="">
                <a
                    href="{{ route('file-manager.municipality.with-category.show', ['type' => $type, 'category' => 'residential']) }}">
                    <img src="{{ asset('images/admin/folder.png') }}" alt="" class="w-24">
            ...
            <div class="">
                <a
                    href="{{ route('file-manager.municipality.with-category.show', ['type' => $type, 'category' => 'special']) }}">
                    <img src="{{ asset('images/admin/folder.png') }}" alt="" class="w-24">
