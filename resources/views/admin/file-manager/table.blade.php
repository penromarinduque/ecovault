                            ...
                            fetch(`/api/files/${permitType}/${municipality}`)
                                ...
                                <div id="dropdownLeft${file.id}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow-lg">
                                    <ul class="py-2 text-sm text-gray-700 border border-gray-200 divide-y divide-gray-400">
                                        <li><a href="/api/files/${file.id}" class="view-button block px-4 py-2 hover:bg-gray-100">View</a></li>
    ...
    <script>
        ...
        function toggleSections(showFileSection) {
            ...
            if (showFileSection) {
                ...
                mainTable.classList.add('order-last');
                ...
                setTimeout(() => {
                    ...
                    mainTable.classList.remove('pointer-events-none');
        ...
        document.body.addEventListener('click', function(event) {
            if (event.target.matches('.edit-button')) {
                toggleSections(true);
                // Additional functionality for editing can go here
                const fileId = event.target.dataset.fileId; // If you want to get the file ID
