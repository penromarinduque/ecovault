...
@section('content')
    <div class="bg-slate-200 h-[600px] rounded-md text-black p-4 ">
        ...
        <div class="grid grid-cols-4 m-16 ">
            <div class="my-4">
                <a href="{{ route('administrative.record.show', ['record' => 'memoranda']) }}">
            ...
            <div class="my-4">
                <a href="{{ route('administrative.record.show', ['record' => 'letters']) }}">
                    <img src="{{ asset('images/admin/folder.png') }}" alt="" class="w-24">
            ...
            <div class="my-4">
                <a href="{{ route('administrative.record.show', ['record' => 'special-orders']) }}">
                    <img src="{{ asset('images/admin/folder.png') }}" alt="" class="w-24">
            ...
            <div class="my-4 items-center fkex">
                <a href="{{ route('administrative.record.show', ['record' => 'reports']) }}">
                    <img src="{{ asset('images/admin/folder.png') }}" alt="" class="w-24">
