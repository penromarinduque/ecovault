    ...
    <nav class="flex justify-between space-x-4 h-full mx-8">
        ...
        <div class="flex space-x-4 items-center">
            <a href="{{ route('login.show') }}"
                class="px-5 py-2.5 gap-1 text-sm font-medium text-white inline-flex items-center bg-transparent hover:bg-blue-800 focus:ring-4 focus:outline-white border boder-white focus:ring-blue-300 rounded-lg text-center">Login
